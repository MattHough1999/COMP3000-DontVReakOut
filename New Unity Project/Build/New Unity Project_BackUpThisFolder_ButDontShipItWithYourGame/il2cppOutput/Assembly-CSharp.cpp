...
IL2CPP_EXTERN_C String_t* _stringLiteral7B758A6350E705B6569348A3AC6F5BCC7B8EA428;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Tasks_newTask_m4D3FD008B07039805386581CBCD694ACAD278240 (Tasks_t1BC60122E07DF74DD2347CF2D2A190295346D638 * __this, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral7B758A6350E705B6569348A3AC6F5BCC7B8EA428);
...
IL_006d:
	{
		...
		int32_t* L_11 = __this->get_address_of_task_15();
		String_t* L_12;
		L_12 = Int32_ToString_m340C0A14D16799421EFDF8A81C8A16FA76D48411((int32_t*)L_11, /*hidden argument*/NULL);
		String_t* L_13;
		L_13 = String_Concat_m4B4AB72618348C5DFBFBA8DED84B9E2EBDB55E1B(_stringLiteral7B758A6350E705B6569348A3AC6F5BCC7B8EA428, L_12, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
...
IL_0087:
	{
		...
		__this->set_task_15(L_14);
		// switch (task)
		int32_t L_15 = __this->get_task_15();
		V_0 = L_15;
		int32_t L_16 = V_0;
		switch (L_16)
		{
...
IL_00b6:
	{
		...
		int32_t L_17;
		L_17 = Random_Range_m4B3A0037ACA057F33C94508F908546B9317D996A(((int32_t)1000), ((int32_t)10000), /*hidden argument*/NULL);
		V_1 = L_17;
		// phone.GetComponent<Phone>().setCorrCode(code.ToString());
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_18 = __this->get_phone_4();
		NullCheck(L_18);
		Phone_t366654086E690ADD0D36B6A28560FD16BFFB553A * L_19;
		L_19 = GameObject_GetComponent_TisPhone_t366654086E690ADD0D36B6A28560FD16BFFB553A_m48A8EE28A6C2EF1290DE78187B501EF832963B06(L_18, /*hidden argument*/GameObject_GetComponent_TisPhone_t366654086E690ADD0D36B6A28560FD16BFFB553A_m48A8EE28A6C2EF1290DE78187B501EF832963B06_RuntimeMethod_var);
		String_t* L_20;
		L_20 = Int32_ToString_m340C0A14D16799421EFDF8A81C8A16FA76D48411((int32_t*)(&V_1), /*hidden argument*/NULL);
		NullCheck(L_19);
		Phone_setCorrCode_mC82D3D2B27D082A9E7F5A089A77BC932D028D372_inline(L_19, L_20, /*hidden argument*/NULL);
		// taskText.text = "Enter: " + code + " on the phone!";
		TextMeshPro_t4C8C961C0939CD311CCC4F5F306C27C5301BD8E4 * L_21 = __this->get_taskText_10();
		String_t* L_22;
		L_22 = Int32_ToString_m340C0A14D16799421EFDF8A81C8A16FA76D48411((int32_t*)(&V_1), /*hidden argument*/NULL);
		String_t* L_23;
		L_23 = String_Concat_m89EAB4C6A96B0E5C3F87300D6BE78D386B9EFC44(_stringLiteral2FECB5C60BD961631D322C08C18B46E324658779, L_22, _stringLiteral3815FC3575E02FA461484820B4D0E454707E4C9D, /*hidden argument*/NULL);
		NullCheck(L_21);
...
IL_010a:
	{
		...
		int32_t L_24;
		L_24 = Random_Range_m4B3A0037ACA057F33C94508F908546B9317D996A(0, ((int32_t)12), /*hidden argument*/NULL);
		V_2 = L_24;
		// COD.GetComponent<ChestOfDrawers>().newTask(drawer.ToString());
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_25 = __this->get_COD_5();
		NullCheck(L_25);
		ChestOfDrawers_t1BD4D2E540FAE5B5992EB472C71C9FA071DD3507 * L_26;
		L_26 = GameObject_GetComponent_TisChestOfDrawers_t1BD4D2E540FAE5B5992EB472C71C9FA071DD3507_m83F1015F3657BBFFBD91BE41069BA7C324278C90(L_25, /*hidden argument*/GameObject_GetComponent_TisChestOfDrawers_t1BD4D2E540FAE5B5992EB472C71C9FA071DD3507_m83F1015F3657BBFFBD91BE41069BA7C324278C90_RuntimeMethod_var);
		String_t* L_27;
		L_27 = Int32_ToString_m340C0A14D16799421EFDF8A81C8A16FA76D48411((int32_t*)(&V_2), /*hidden argument*/NULL);
		NullCheck(L_26);
		ChestOfDrawers_newTask_mF256A362734587D363C94B13991BEAD22ED72FAD_inline(L_26, L_27, /*hidden argument*/NULL);
		// taskText.text = "Place a cup in Drawer: " + drawer + "!";
		TextMeshPro_t4C8C961C0939CD311CCC4F5F306C27C5301BD8E4 * L_28 = __this->get_taskText_10();
		String_t* L_29;
		L_29 = Int32_ToString_m340C0A14D16799421EFDF8A81C8A16FA76D48411((int32_t*)(&V_2), /*hidden argument*/NULL);
		String_t* L_30;
		L_30 = String_Concat_m89EAB4C6A96B0E5C3F87300D6BE78D386B9EFC44(_stringLiteral1DE9753C46663BE241D05B06CC98C081D0C3B6A6, L_29, _stringLiteral15196F05B117690F3E12E56AA0C43803EA0D2A46, /*hidden argument*/NULL);
		NullCheck(L_28);
...
IL_0154:
	{
		...
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_31 = __this->get_fireAlarm_6();
		NullCheck(L_31);
		FireAlarm_tF2F1D874B825F9956221789C1A82174074F470EC * L_32;
		L_32 = GameObject_GetComponent_TisFireAlarm_tF2F1D874B825F9956221789C1A82174074F470EC_mB7AF319B96BE747B19F8A8D1258F89508A2C6644(L_31, /*hidden argument*/GameObject_GetComponent_TisFireAlarm_tF2F1D874B825F9956221789C1A82174074F470EC_mB7AF319B96BE747B19F8A8D1258F89508A2C6644_RuntimeMethod_var);
		NullCheck(L_32);
		FireAlarm_goingOff_mE10702E3ED0069575EA220F8370C8E46A84E6CB8(L_32, /*hidden argument*/NULL);
		// taskText.text = "Punch the fireAlarm!";
		TextMeshPro_t4C8C961C0939CD311CCC4F5F306C27C5301BD8E4 * L_33 = __this->get_taskText_10();
		NullCheck(L_33);
		VirtualActionInvoker1< String_t* >::Invoke(66 /* System.Void TMPro.TMP_Text::set_text(System.String) */, L_33, _stringLiteralC1506101EE86984E123F0459CDE076EFF3BA6160);
		// taskInProgress = true;
		__this->set_taskInProgress_16((bool)1);
		// break;
		goto IL_01a4;
...
IL_017d:
	{
		...
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_34 = __this->get_kettle_7();
		NullCheck(L_34);
		Kettle_tE4B39822267F35607D82F1ED2B6A1422A985B6D9 * L_35;
		L_35 = GameObject_GetComponent_TisKettle_tE4B39822267F35607D82F1ED2B6A1422A985B6D9_m3F920FB32B16B0D527881B6088C40857CF38E8EE(L_34, /*hidden argument*/GameObject_GetComponent_TisKettle_tE4B39822267F35607D82F1ED2B6A1422A985B6D9_m3F920FB32B16B0D527881B6088C40857CF38E8EE_RuntimeMethod_var);
		NullCheck(L_35);
		Kettle_newTask_m398105B971CF7B58ABF79A7AB12FC9B8C6DC95D3(L_35, /*hidden argument*/NULL);
		// taskText.text = "Put the kettle on!";
		TextMeshPro_t4C8C961C0939CD311CCC4F5F306C27C5301BD8E4 * L_36 = __this->get_taskText_10();
		NullCheck(L_36);
		VirtualActionInvoker1< String_t* >::Invoke(66 /* System.Void TMPro.TMP_Text::set_text(System.String) */, L_36, _stringLiteralF2CCF505529B00E1073161E489C0CA545BBF6CAC);
		// taskInProgress = true;
		__this->set_taskInProgress_16((bool)1);
	}
...
IL_01a4:
	{
		...
		int32_t* L_37 = __this->get_address_of_task_15();
		String_t* L_38;
		L_38 = Int32_ToString_m340C0A14D16799421EFDF8A81C8A16FA76D48411((int32_t*)L_37, /*hidden argument*/NULL);
		String_t* L_39;
		L_39 = String_Concat_m4B4AB72618348C5DFBFBA8DED84B9E2EBDB55E1B(_stringLiteralB483A8C157D1E2E274D640A7222EA10FEE792545, L_38, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
